const AppData = {
  user: {
    name: "Missy", role: "高级法务经理", avatar: "M",
  ...
  cases: [
    { id: "TM-2026-0042", name: "云智", type: "驳回复审", category: "国内案件", status: "审查中", agent: "智联知识产权", deadline: "2026-05-06", owner: "Missy", progress: 65 },
    { id: "TM-2026-0031", name: "智联", type: "异议答辩", category: "国内案件", status: "答辩期", agent: "元健律师事务所", deadline: "2026-05-07", owner: "Missy", progress: 30 },
    { id: "TM-2025-0189", name: "海翼", type: "马德里申请", category: "海外案件", status: "WIPO审查", agent: "WIPO/当地所", deadline: "2026-05-15", owner: "李流程", progress: 45 },
    { id: "TM-2026-0028", name: "明达", type: "不予注册复审", category: "国内案件", status: "准备材料", agent: "智联知识产权", deadline: "2026-05-22", owner: "Missy", progress: 20 },
    { id: "TM-2026-0056", name: "悦动", type: "新申请", category: "国内案件", status: "受理中", agent: "元健律师事务所", deadline: "2026-06-01", owner: "王流程", progress: 15 },
    { id: "TM-2025-0098", name: "星联", type: "续展", category: "国内案件", status: "待缴费", agent: "智联知识产权", deadline: "2026-05-10", owner: "Missy", progress: 80 },
    { id: "TM-2026-0071", name: "睿思", type: "撤三答辩", category: "国内案件", status: "证据收集", agent: "元健律师事务所", deadline: "2026-06-10", owner: "Missy", progress: 40 },
  ...
  // 检索中心相关数据
  searchCases: [
    { caseNo: 'SC-2026-0001', subject: '云智商标检索', currentNode: '检索完成', handler: 'Missy', prevTime: '2026-05-03', searchMethod: '近似检索', agency: '智联知识产权', requester: '王经理', dept: '品牌管理部', brand: '云智', product: '智能手机', project: '云智项目', priority: '高', country: '中国', appNo: 'TM-2026-0042', agencyAdvice: '建议注册', adminAdvice: '同意', searchDeadline: '2026-05-10', completeDeadline: '2026-05-15', createdDate: '2026-05-01' },
    ...
    { caseNo: 'SC-2026-0003', subject: '海翼欧盟注册检索', currentNode: '审核中', handler: 'Missy', prevTime: '2026-05-01', searchMethod: '官方数据库检索', agency: '启航知识产权', requester: '陈主管', dept: '知识产权部', brand: '海翼', product: '智能家居', project: '海翼项目', priority: '中', country: '欧盟', appNo: 'TM-2025-0189', agencyAdvice: '建议注册', adminAdvice: '同意', searchDeadline: '2026-05-05', completeDeadline: '2026-05-08', createdDate: '2026-04-25' },
    ...
    { caseNo: 'SC-2026-0006', subject: '睿思驳回复审检索', currentNode: '检索完成', handler: 'Missy', prevTime: '2026-04-28', searchMethod: '人工分析检索', agency: '智联知识产权', requester: '周主管', dept: '知识产权部', brand: '睿思', product: '人工智能', project: '智联项目', priority: '高', country: '中国', appNo: 'TM-2026-0071', agencyAdvice: '建议分割申请', adminAdvice: '同意', searchDeadline: '2026-05-06', completeDeadline: '2026-05-10', createdDate: '2026-04-22' },
    ...
    { caseNo: 'SC-2026-0010', subject: '启航韩国注册检索', currentNode: '检索完成', handler: 'Missy', prevTime: '2026-04-24', searchMethod: '综合检索', agency: '启航知识产权', requester: '冯专员', dept: '知识产权部', brand: '启航', product: '物联网平台', project: '悦动项目', priority: '中', country: '韩国', appNo: 'TM-2025-0203', agencyAdvice: '建议注册', adminAdvice: '同意', searchDeadline: '2026-05-11', completeDeadline: '2026-05-16', createdDate: '2026-04-15' }
  ],
  ...
  // 用印流程数据
  authExternal: [
    { id: 'AE-2026-0001', appNo: 'AE-2026-0001', trademarkName: '云智', dept: '品牌管理部', requesterEmail: 'wangjing@xiaomi.com', usageScenario: '产品包装、官网展示、线下门店物料', countries: ['中国', '欧盟'], authPeriodStart: '2026-06-01', authPeriodEnd: '2027-05-31', licenseeName: '深圳云智科技有限公司', feishuApprovalNo: 'FS-BRAND-2026-001', needCertificate: true, watermarkText: '内部使用，未经授权禁止转载', status: 'pending', specificTrademarkNo: '', confirmedWatermark: '', finalFeishuNo: '', approver: '', approvalTime: '', approvalOpinion: '' },
    { id: 'AE-2026-0002', appNo: 'AE-2026-0002', trademarkName: '智联', dept: '海外市场部', requesterEmail: 'zhaoqi@xiaomi.com', usageScenario: '海外展会宣传册、产品说明书', countries: ['美国', '日本'], authPeriodStart: '2026-07-01', authPeriodEnd: '2028-06-30', licenseeName: 'Horizon Tech Inc.', feishuApprovalNo: 'FS-BRAND-2026-002', needCertificate: true, watermarkText: '内部使用，未经授权禁止转载', status: 'reviewing', specificTrademarkNo: '78954401,78954402', confirmedWatermark: '内部使用，未经授权禁止转载', finalFeishuNo: 'FS-BRAND-2026-002-A', approver: 'Missy', approvalTime: '2026-05-02', approvalOpinion: '同意授权，请提供高清商标证扫描件' },
    { id: 'AE-2026-0003', appNo: 'AE-2026-0003', trademarkName: '海翼', dept: '产品研发部', requesterEmail: 'chenwei@xiaomi.com', usageScenario: '智能出行产品线品牌联名', countries: ['中国'], authPeriodStart: '2026-08-01', authPeriodEnd: '2027-07-31', licenseeName: '北京海翼出行科技有限公司', feishuApprovalNo: 'FS-BRAND-2026-003', needCertificate: false, watermarkText: '内部使用，未经授权禁止转载', status: 'approved', specificTrademarkNo: '78954501,78954502', confirmedWatermark: '内部使用，未经授权禁止转载', finalFeishuNo: 'FS-BRAND-2026-003-A', approver: '李流程', approvalTime: '2026-05-01', approvalOpinion: '直接通过，无需商标证' },
    { id: 'AE-2026-0004', appNo: 'AE-2026-0004', trademarkName: '星联', dept: '法务部', requesterEmail: 'liumin@xiaomi.com', usageScenario: '卫星通信设备外包装', countries: ['中国', '美国', '欧盟'], authPeriodStart: '2026-09-01', authPeriodEnd: '2027-08-31', licenseeName: '深圳星联通信有限公司', feishuApprovalNo: 'FS-BRAND-2026-004', needCertificate: true, watermarkText: '内部使用，未经授权禁止转载', status: 'rejected', specificTrademarkNo: '', confirmedWatermark: '', finalFeishuNo: '', approver: 'Missy', approvalTime: '2026-04-28', approvalOpinion: '授权范围过大，建议缩小至中国区域后重新提交' },
    { id: 'AE-2026-0005', appNo: 'AE-2026-0005', trademarkName: '悦动', dept: '品牌管理部', requesterEmail: 'sunli@xiaomi.com', usageScenario: '运动服饰联名款吊牌、包装盒', countries: ['中国', '韩国'], authPeriodStart: '2026-10-01', authPeriodEnd: '2027-09-30', licenseeName: '上海悦动服饰有限公司', feishuApprovalNo: 'FS-BRAND-2026-005', needCertificate: true, watermarkText: '内部使用，未经授权禁止转载', status: 'pending', specificTrademarkNo: '', confirmedWatermark: '', finalFeishuNo: '', approver: '', approvalTime: '', approvalOpinion: '' }
  ],
  authInternal: [
    { id: 'AI-2026-0001', appNo: 'AI-2026-0001', trademarkName: '云智', dept: '人力资源部', requesterEmail: 'hr@xiaomi.com', usageScenario: '员工工牌、内部文化墙、培训资料', countries: ['中国'], authPeriodStart: '2026-06-01', authPeriodEnd: '2027-05-31', licenseeName: '小米集团人力资源部', feishuApprovalNo: 'FS-BRAND-2026-101', needCertificate: false, watermarkText: '仅供内部使用', status: 'approved', specificTrademarkNo: '78954321,78954322', confirmedWatermark: '仅供内部使用', finalFeishuNo: 'FS-BRAND-2026-101-A', approver: 'Missy', approvalTime: '2026-05-03', approvalOpinion: '内部使用，直接通过' },
    { id: 'AI-2026-0002', appNo: 'AI-2026-0002', trademarkName: '智联', dept: '行政部', requesterEmail: 'admin@xiaomi.com', usageScenario: '办公区域标识、会议室命名', countries: ['中国'], authPeriodStart: '2026-07-01', authPeriodEnd: '2027-06-30', licenseeName: '小米集团行政部', feishuApprovalNo: 'FS-BRAND-2026-102', needCertificate: false, watermarkText: '仅供内部使用', status: 'reviewing', specificTrademarkNo: '78954401', confirmedWatermark: '仅供内部使用', finalFeishuNo: 'FS-BRAND-2026-102-A', approver: '李流程', approvalTime: '2026-05-02', approvalOpinion: '同意，确认仅用于北京总部办公区' },
    { id: 'AI-2026-0003', appNo: 'AI-2026-0003', trademarkName: '海翼', dept: '财务部', requesterEmail: 'finance@xiaomi.com', usageScenario: '年度财报封面、投资者演示文稿', countries: ['中国'], authPeriodStart: '2026-08-01', authPeriodEnd: '2027-07-31', licenseeName: '小米集团财务部', feishuApprovalNo: 'FS-BRAND-2026-103', needCertificate: false, watermarkText: '仅供内部使用', status: 'pending', specificTrademarkNo: '', confirmedWatermark: '', finalFeishuNo: '', approver: '', approvalTime: '', approvalOpinion: '' },
    { id: 'AI-2026-0004', appNo: 'AI-2026-0004', trademarkName: '星联', dept: '知识产权部', requesterEmail: 'ipr@xiaomi.com', usageScenario: '内部专利墙展示、技术评审材料', countries: ['中国'], authPeriodStart: '2026-09-01', authPeriodEnd: '2027-08-31', licenseeName: '小米集团知识产权部', feishuApprovalNo: 'FS-BRAND-2026-104', needCertificate: true, watermarkText: '仅供内部使用', status: 'rejected', specificTrademarkNo: '', confirmedWatermark: '', finalFeishuNo: '', approver: 'Missy', approvalTime: '2026-04-25', approvalOpinion: '该商标已到期第41类，请更新续展后再申请' },
    { id: 'AI-2026-0005', appNo: 'AI-2026-0005', trademarkName: '悦动', dept: '市场部', requesterEmail: 'marketing@xiaomi.com', usageScenario: '内部活动策划、员工运动会物料', countries: ['中国'], authPeriodStart: '2026-10-01', authPeriodEnd: '2027-09-30', licenseeName: '小米集团市场部', feishuApprovalNo: 'FS-BRAND-2026-105', needCertificate: false, watermarkText: '仅供内部使用', status: 'pending', specificTrademarkNo: '', confirmedWatermark: '', finalFeishuNo: '', approver: '', approvalTime: '', approvalOpinion: '' }
  ],
