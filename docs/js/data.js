const AppData = {
  ...
  authExternal: [
    ...
    { id: 'AE-2026-0002', appNo: 'AE-2026-0002', trademarkName: '智联', dept: '海外市场部', requesterEmail: 'zhaoqi@xiaomi.com', usageScenario: '海外展会宣传册、产品说明书', countries: ['美国', '日本'], authPeriodStart: '2026-07-01', authPeriodEnd: '2028-06-30', licenseeName: 'Horizon Tech Inc.', feishuApprovalNo: 'FS-BRAND-2026-002', needCertificate: true, watermarkText: '内部使用，未经授权禁止转载', status: 'reviewing', specificTrademarkNo: '78954401,78954402', confirmedWatermark: '内部使用，未经授权禁止转载', finalFeishuNo: 'FS-BRAND-2026-002-A', approver: '张法务', approvalTime: '2026-05-02', approvalOpinion: '同意授权，请提供高清商标证扫描件' },
